"""Veredito do juiz — 3 estados (valido/invalido/nao_coberto), portado de
survey_pipeline/schema.py (que já implementa o desenho do survey do chefe:
abstenção honesta em vez de forçar um veredito quando nenhuma regra cobre).
"""
